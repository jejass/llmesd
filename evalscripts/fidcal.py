...
def main(args):
    # 加载生成图片
    gen_images = sorted(glob(os.path.join(args.gen_path, "*.png")))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Calculate FID between generated images and COCO stats.")
    parser.add_argument("--gen_path", type=str, required=True, help="Path to generated images folder.")
